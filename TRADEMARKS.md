...
that a modified version is an official release, is maintained by the
ANYstructure project, or is endorsed by the original authors.

Modified distributions should use a clearly distinguishable product name
and branding.