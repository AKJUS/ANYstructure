...
class CreateOptGeoWindow():
    ...
    def __init__(self, master, app=None):
        ...
        ent_fup.place(x=start_x + dx * 12, y=start_y + 13 * dy)
        ...
        ent_fdwn.place(x=start_x + dx * 12, y=start_y + 14 * dy)
    ...
    def update_running_time(self, *args):
        ...
        elif self._new_check_buckling_ml_cl.get() or self._new_check_buckling_ml_numeric.get():
            self._new_check_buckling.set(False)
            self._new_check_local_buckling.set(False)
